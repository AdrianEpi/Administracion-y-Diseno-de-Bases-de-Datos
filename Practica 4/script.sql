...
CREATE TABLE IF NOT EXISTS EmpleadoTrabajaZona (
  ...
  Zona_Vivero_Nombre VARCHAR(30) NOT NULL,
  PRIMARY KEY (Fecha_Inicio, Zona_Nombre, Zona_Vivero_Nombre),
  CONSTRAINT fk_EmpleadoTrabajaZona_Zona
    FOREIGN KEY (Zona_Nombre, Zona_Vivero_Nombre)
    REFERENCES Zona (Nombre, Vivero_Nombre)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
-- --------------------------------------
-- Data for table EmpleadoTrabajaZona
-- --------------------------------------
INSERT INTO EmpleadoTrabajaZona (Fecha_Inicio, Fecha_Fin, Ventas, Zona_Nombre, Zona_Vivero_Nombre) VALUES ('01/01/2019', '01/01/2021', NULL, 'Almacén', 'Vivero La Laguna');
INSERT INTO EmpleadoTrabajaZona (Fecha_Inicio, Fecha_Fin, Ventas, Zona_Nombre, Zona_Vivero_Nombre) VALUES ('03/01/2020', '03/01/2021', NULL, 'Cajas ', 'Vivero La Laguna');
INSERT INTO EmpleadoTrabajaZona (Fecha_Inicio, Fecha_Fin, Ventas, Zona_Nombre, Zona_Vivero_Nombre) VALUES ('02/01/2017', '02/01/2021', NULL, 'Exterior', 'Vivero Santa Cruz');
...
CREATE TABLE IF NOT EXISTS Empleado (
  ...
  CONSTRAINT fk_Empleado_EmpleadoTrabajaZona
    FOREIGN KEY (EmpleadoTrabajaZona_Fecha_Inicio , EmpleadoTrabajaZona_Zona_Nombre , EmpleadoTrabajaZona_Zona_Vivero_Nombre)
    REFERENCES EmpleadoTrabajaZona (Fecha_Inicio , Zona_Nombre , Zona_Vivero_Nombre)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION);
-- --------------------------------------
...
CREATE TABLE IF NOT EXISTS Producto (
  ...
  Zona_Nombre VARCHAR(50) NOT NULL,
  Zona_Vivero_Nombre VARCHAR(30) NOT NULL,
  PRIMARY KEY (Codigo_Producto, Zona_Nombre, Zona_Vivero_Nombre),
...
-- --------------------------------------
INSERT INTO Producto (Codigo_Producto, Precio, Stock, Zona_Nombre, Zona_Vivero_Nombre) VALUES (0001, 15.99, NULL, 'Almacén', 'Vivero La Laguna');
INSERT INTO Producto (Codigo_Producto, Precio, Stock, Zona_Nombre, Zona_Vivero_Nombre) VALUES (0002, 12.36, NULL, 'Almacén', 'Vivero La Laguna');
INSERT INTO Producto (Codigo_Producto, Precio, Stock, Zona_Nombre, Zona_Vivero_Nombre) VALUES (0003, 9.45, NULL, 'Cajas', 'Vivero Santa Cruz');
INSERT INTO Producto (Codigo_Producto, Precio, Stock, Zona_Nombre, Zona_Vivero_Nombre) VALUES (0004, 2.36, NULL, 'Exterior', 'Vivero Santa Cruz');
...
CREATE TABLE IF NOT EXISTS ClienteCompraEmpleadoProducto (
  ...
  CONSTRAINT fk_ClienteCompraEmpleadoProducto_Producto
    FOREIGN KEY (Producto_Codigo_Producto , Producto_Zona_Nombre , Producto_Zona_Vivero_Nombre)
    REFERENCES Producto (Codigo_Producto , Zona_Nombre , Zona_Vivero_Nombre)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
